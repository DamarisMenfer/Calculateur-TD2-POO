...
public class TestParametre {
    ...
    public TestParametre(double longueur, double largeur, double hauteur, double poids, String dest, String expected){
    ...
    @org.junit.Test
    public void testCalculateur() throws Exception {

        Calculateur calculateur = new Calculateur();
        Double aDouble = Double.valueOf(expected);
        assertEquals(aDouble.doubleValue(),calculateur.calculerFrais(new Dimension(longueur,largeur,hauteur),poids,dest),0.001);
    }

    @org.junit.Test
    public void testShippingCostCalculateur() throws Exception {

        ShippingCostsCalculator calculateur = new ShippingCostsCalculator();
        Package packageA = new Package(hauteur,largeur,longueur,poids);
